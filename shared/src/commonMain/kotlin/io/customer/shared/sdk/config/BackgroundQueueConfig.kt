...
class BackgroundQueueConfig private constructor(
    ...
    class Builder {
         ...
         */
        fun setBatchDelayMinTasks(batchDelayMinTasks: Int) {
         ...
         */
        fun setBatchDelayMaxDelayInSeconds(batchDelayMaxDelayInSeconds: Int) {
         ...
         */
        fun setBatchTasksMax(batchTasksMax: Int) {
